...
/**
 * Created by facet on 02/08/16.
 */
public class helpSegProperty implements Serializable {
    ...
    public helpSegProperty(String name, Object value, boolean required, int size, String completeMethod, String hi_lo, int segNum){
        this.name=name;
        this.value=value;
